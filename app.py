...
if submit_button:
    if height > 0 and weight > 0:
        ...
        st.write(f"To be within the ideal BMI range of 18.5 to 24.9 for your height ({height} cm), "
                 f"your weight should be between {weight_min:.2f} kg to {weight_max:.2f} kg.")
